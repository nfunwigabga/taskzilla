...
namespace Illuminate\Database\Schema {
    ...
    class Blueprint
    {
        ...
        {
            return \Illuminate\Database\Schema\Blueprint::primaryKey();
        }
        ...
        {
            return \Illuminate\Database\Schema\Blueprint::foreignKey($name);
        }
         ...
         * @see \App\Providers\AppServiceProvider::boot()
         */
        public static function morphFields($name, $indexName = null)
        {
            return \Illuminate\Database\Schema\Blueprint::morphFields($name, $indexName);
        }
         ...
         * @see \App\Providers\AppServiceProvider::boot()
         */
        public static function nullableMorphFields($name, $indexName = null)
        {
            return \Illuminate\Database\Schema\Blueprint::nullableMorphFields($name, $indexName);
        }
