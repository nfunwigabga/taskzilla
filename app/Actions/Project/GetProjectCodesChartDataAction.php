...
class GetProjectCodesChartDataAction
{
    public static function run(User $user, Project $project, string $field, string $type, array $filters)
    {
        ...
        $query = $project->tasks()
            ...
            ->where('codes.project_id', $project->id)
